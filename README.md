...
```
The above Dockerfile derives from nicolanardino/ubuntu-oracle-java-8:latest, which is an image starting from ubuntu:latest LTS with Oracle Java 8. That was necessary because I've added a container healthcheck, which required curl.
That image is on my DockerHub account, https://hub.docker.com/r/nicolanardino/ubuntu-oracle-java-8/.
