 ...
 * */
public enum MongoDBEventsServiceClient implements MongoDBEventsServiceClientInterface{
	INSTANCE;
	...
	public static void main(final String[] args) {
		MongoDBEventsServiceClient.INSTANCE.addEvents(
		...
		MongoDBEventsServiceClient.INSTANCE.getEvents("http://localhost:9094/events/getEtherTransferEvents").forEach(System.out::println);
		MongoDBEventsServiceClient.INSTANCE.addEvents(
		...
		final List<Object> events = MongoDBEventsServiceClient.INSTANCE.getEvents("http://localhost:9094/events/getSmartContractEvents");
